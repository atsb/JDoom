...
public enum Settings {
    ...
    /**
     * Mocha Doom (jdoom.cfg), these can be defined to anything and will be sorded by name
     */
    ...
    parallelism_patch_columns(FILE_MOCHADOOM, 1), // When drawing screen graphics patches, this speeds up column drawing, <= 0 is serial
