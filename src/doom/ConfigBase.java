...
public enum ConfigBase {
    ...
    public static final Files
        ...
        FILE_MOCHADOOM = new Files("jdoom.cfg");
    ...
    public static class Files {
        ...
        private String[] getPaths() {
            ...
            return paths = new String[] {
                /**
                 * Uncomment the next line and it will load default.cfg and jdoom.cfg from user home dir
    ...
    public static List<Files> getFiles() {
        ...
        /**
         * If there is no such argument, load default.cfg (or .doomrc) and jdoom.cfg
         */
        ) {
            ret.add(FILE_DOOM);
